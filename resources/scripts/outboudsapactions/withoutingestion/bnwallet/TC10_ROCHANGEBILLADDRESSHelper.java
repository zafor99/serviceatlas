...
/**
 * Script Name   : <b>TC10_ROCHANGEBILLADDRESS</b><br>
 * Generated     : <b>2014/08/04 10:47:03 AM</b><br>
 ...
 * @author zsadeque
 */
public abstract class TC10_ROCHANGEBILLADDRESSHelper extends framework.AtlasScriptbase
{
	/**
	...
	/**
	 * Locate and return the verification point Z135_processed object in the SUT.
	 */
	protected IFtVerificationPoint Z135_processedVP() 
	{
		return vp("Z135_processed");
	}
	protected IFtVerificationPoint Z135_processedVP(TestObject anchor)
	{
		return vp("Z135_processed", anchor);
	}
	
	

	protected TC10_ROCHANGEBILLADDRESSHelper()
	{
		setScriptName("scripts.outboudsapactions.withoutingestion.bnwallet.TC10_ROCHANGEBILLADDRESS");
	}
