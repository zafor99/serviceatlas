...
import resources.sap_scripts.physical.TC02_BookPurchaseWExpressShippingHelper;
 ...
 * @author zsadeque
 */
public class TC02_BookPurchaseWExpressShipping extends TC02_BookPurchaseWExpressShippingHelper
{
	/**
	...
	public void testMain(Object[] args) 
	{
		...
		checkout().USPhysicalPurchase().submitOrder(true,"EDO","9780894807626");
		//checkout().USPhysicalPurchase().submitExpressShippingOrder();
		...
		//TODO: Need to check the email send.
	}
