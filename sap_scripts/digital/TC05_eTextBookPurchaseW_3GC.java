...
import resources.sap_scripts.digital.TC05_eTextBookPurchaseW_3GCHelper;
 ...
 * @author zsadeque
 */
public class TC05_eTextBookPurchaseW_3GC extends TC05_eTextBookPurchaseW_3GCHelper
{
	/**
	...
	public void testMain(Object[] args) throws IOException 
	{
		...
		//TODO: Order is not going through SAP. Need to update the baseline
		String orderNumber,timeStamp,hr,min = null;
		
		//Submit IP orders 
		instantPurchase().purchaseDigitalItemWith3GC("9783527644513", "10", "10","10");
