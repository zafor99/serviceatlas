...
import resources.sap_scripts.digital.TC06_NookVideoPurchaseW_CCHelper;
 ...
 * @author zsadeque
 */
public class TC06_NookVideoPurchaseW_CC extends TC06_NookVideoPurchaseW_CCHelper
{
	/**
	...
	public void testMain(Object[] args) throws IOException 
	{
		...
		//Submit IP orders 2949000000284
		instantPurchase().submitIPVideoPurchase("2949000000284");
		//instantPurchase().submitIPVideoPurchase("2949000013611");
