...
import resources.scripts.outboudsapactions.outboundInvoice.DIGSHIPCONFIRM.TC03_eBookHelper;
 ...
 * @author zsadeque
 */
public class TC03_eBook extends TC03_eBookHelper
{
	/**
	...
	public void testMain(Object[] args) throws ClassNotFoundException 
	{
		...
		if(orderNumber.length()>2){
			writeInvoicedBNOrdersToExcel("TC03_eBook", timeStamp, orderNumber, ean,customerID);
