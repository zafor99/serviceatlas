...
import resources.scripts.outboudsapactions.outboundInvoice.DIGSHIPCONFIRM.TC07_eBookAgencyModelHelper;
 ...
 * @author zsadeque
 */
public class TC07_eBookAgencyModel extends TC07_eBookAgencyModelHelper
{
	/**
	...
	public void testMain(Object[] args) throws ClassNotFoundException 
	{
		...
		if(orderNumber.length()>2){
			writeInvoicedBNOrdersToExcel("TC07_eBookAgencyModel", timeStamp, orderNumber, ean,customerID);
