...
import resources.scripts.outboudsapactions.outboundInvoice.DIGSHIPCONFIRM.TC05_videoRentalHelper;
 ...
 * @author zsadeque
 */
public class TC05_videoRental extends TC05_videoRentalHelper
{
	/**
	...
	public void testMain(Object[] args) throws ClassNotFoundException, IOException 
	{
		...
		if(orderNumber.length()>2){
			writeInvoicedBNOrdersToExcel("TC05_videoRental", timeStamp, orderNumber, ean,customerID);
