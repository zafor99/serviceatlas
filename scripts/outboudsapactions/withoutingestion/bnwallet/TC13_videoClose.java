...
import resources.scripts.outboudsapactions.withoutingestion.bnwallet.TC13_videoCloseHelper;
 ...
 * @author zsadeque
 */
public class TC13_videoClose extends TC13_videoCloseHelper
{
	/**
	...
	//	delayFor(10);
		...
		//	writeOutboundBNOrdersToExcel("TC08_04_OpenAndClose", timeStamp, orderNumber, ean,customerID);
