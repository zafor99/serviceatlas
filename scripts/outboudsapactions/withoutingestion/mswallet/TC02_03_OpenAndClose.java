...
import resources.scripts.outboudsapactions.withoutingestion.mswallet.TC02_03_OpenAndCloseHelper;
...
public class TC02_03_OpenAndClose extends TC02_03_OpenAndCloseHelper
{
	...
	public void testMain(Object[] args) throws ClassNotFoundException 
	{
		...
		String filePath,accessToken,ean,orderNumber,purchaseRequisition, poNumber,status,iDoc,customerID,timeStamp,orderStatus = null;
		...
		if(orderNumber.length()>2){
			writeOutboundMSWalletOrdersToExcel("TC02_03_OpenAndClose", timeStamp, orderNumber, ean,customerID);
