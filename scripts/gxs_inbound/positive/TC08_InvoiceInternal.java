...
import resources.scripts.gxs_inbound.positive.TC08_InvoiceInternalHelper;
 ...
 * @author zsadeque
 */
public class TC08_InvoiceInternal extends TC08_InvoiceInternalHelper
{
	/**
	...
	{
		atlas().invoiceService().loadXmlFile("gxs_inbound\\Positive\\TC08_InvoiceInternal.xml");
		...
		atlas().invoiceService().verifyResponse("TC08_InvoiceInternal", "201");
