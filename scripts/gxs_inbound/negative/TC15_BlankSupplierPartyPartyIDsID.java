...
import resources.scripts.gxs_inbound.negative.TC15_BlankSupplierPartyPartyIDsIDHelper;
 ...
 * @author zsadeque
 */
public class TC15_BlankSupplierPartyPartyIDsID extends TC15_BlankSupplierPartyPartyIDsIDHelper
{
	/**
	...
	public void testMain(Object[] args) 
	{
		...
		atlas().advanceShipNotice().verifyResponse("TC15_BlankSupplierPartyPartyIDsID_01", "422");
		atlas().advanceShipNotice().verifyResponseBody("TC15_BlankSupplierPartyPartyIDsID_02", "Object failed validation assertions.\n - [/DataArea/Shipment[*]/ShipmentHeader/SupplierParty/PartyIDs/ID[0]/value] '' must be of at least length '1'");
	}
}
