 ...
 */
public  class OrderManagementServReqPageOrderDetailsPanelModel extends WebDriverModelBase
{
	private WebDriver driver = null;
	public OrderManagementServReqPageOrderDetailsPanelModel(WebDriver driver){
		super(driver);
		this.driver = driver;
	}
	public WebElement container(){
		...
		try {
			...
			container = driver.findElement(By.id("C19_W70_V71_V77_0001"));
	...
	public CRMCustomTableModel orderItemsDetailTable(){		
		return new CRMCustomTableModel(driver, container(), By.xpath("//table[@id='C21_W73_V74_V76_ConfCellTable_TableHeader']"));
