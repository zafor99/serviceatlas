 ...
 */
public  class OrderManagementOrderPageOrderHeaderDetailPanelModel extends WebDriverModelBase
{
	private WebDriver driver = null;
	public OrderManagementOrderPageOrderHeaderDetailPanelModel(WebDriver driver){
		super(driver);
		this.driver = driver;
	}
